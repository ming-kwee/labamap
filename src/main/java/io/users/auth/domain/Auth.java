...
public class Auth extends AbstractAuth {
  ...
  @Override
  public Effect<Empty> register(AuthDomain.AuthState currentState, AuthActionApi.Auth command) {
  ...
  @Override
  public Effect<AuthActionApi.Auth> login(AuthDomain.AuthState currentState, AuthApi.GetLoginRequest command) {
    if (currentState.getEmail().equals(command.getEmail())
