...
public abstract class UserStateSubscriptionClient extends UserStateSubscriptionClientPowerApi implements UserStateSubscription, AkkaGrpcClient {
  ...
  protected final static class DefaultUserStateSubscriptionClient extends UserStateSubscriptionClient {
      ...
      private final SingleResponseRequestBuilder<components.users.user.domain.UserDomain.UserState, components.users.user.api.UserApi.User> onStateChangeRequestBuilder(akka.grpc.internal.InternalChannel channel){
         ...
         */
        public java.util.concurrent.CompletionStage<components.users.user.api.UserApi.User> onStateChange(components.users.user.domain.UserDomain.UserState request) {
        ...
        private static MethodDescriptor<components.users.user.domain.UserDomain.UserState, components.users.user.api.UserApi.User> onStateChangeDescriptor =
          MethodDescriptor.<components.users.user.domain.UserDomain.UserState, components.users.user.api.UserApi.User>newBuilder()
            .setType(
   MethodDescriptor.MethodType.UNARY 
            ...
            .setFullMethodName(MethodDescriptor.generateFullMethodName("components.users.user.action.UserStateSubscription", "OnStateChange"))
            .setRequestMarshaller(new ProtoMarshaller<components.users.user.domain.UserDomain.UserState>(UserStateSerializer))
